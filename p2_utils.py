...
def task1_2(T: list[int, int] = [[40, 41], [400, 401], [4000, 4001]], N: int = 50000) -> None:
    ...
    Args:
        x - position to look for the particle # VERIFY → NEED TO CHECK EVERY POSITION X OR A GIVEN ONE???
        tf - time to look for the particle
    ...
    for tf in T:
        ...
        sns.scatterplot(sample_probability, label = 'Sample result')
